...
def handle_requests():
    ...
    valid_servers = ["PAK", "BR", "US", "SAC", "NA", "BD", "RU"]
    ...
    # Choose like URL
    if server_name == "PAK":
        like_url = "https://client.PAK.freefiremobile.com/LikeProfile"
    elif server_name in {"BR", "US", "SAC", "NA"}:
...
def add_account():
    ...
    Usage: /add_account?uid=123456&pass=xyz&region=PAK&key=AJAY
    """
    ...
    valid_regions = ["PAK", "BR", "US", "SAC", "NA", "BD", "RU"]
...
if __name__ == '__main__':
    ...
    print("📁 Account files: account_pak.txt, account_br.txt, account_bd.txt")
